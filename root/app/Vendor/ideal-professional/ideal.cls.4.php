	...
	*/
	...
	class IdealRequest
	{
		...
		function setAquirer($sAquirer, $bTestMode = false)
		{
			...
			elseif(strpos($sAquirer, 'sim') !== false) // IDEAL SIMULATOR
			{
			...
			{
				$this->setError('Unknown aquirer. Please use Rabobank, ING Bank or ABN Amro.', false, __FILE__, __LINE__);
				return false;
			}
		}
